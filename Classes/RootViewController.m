...
//            jid = [XMPPJID jidWithString:[NSString stringWithFormat:@"%@@%@",(NSString *)user.displayName,@"cdn-2412b6cf3dc"]];
            jid = [XMPPJID jidWithString:[NSString stringWithFormat:@"%@@%@",(NSString *)user.displayName,@"kingtekimacbook-pro.local"]];
...
//	
//    if(indexPath == 0){
//        static NSString *cellname = @"requestCell";
...
//    [self.navigationController pushViewController:[[self appDelegate] addBuddyController] animated:YES];
//}
